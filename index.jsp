...
try
{
	...
	if(request.getParameter("btn_login") != null){ //check login button click event not null
		...
		String selectSql =
		"SELECT role_name FROM users JOIN user_roles ON users.user_id=user_roles.user_id JOIN roles ON user_roles.role_id=roles.role_id WHERE username='" + username + "' AND password='" + password + "'";
